...
<head>
   <meta charset="utf-8">
   <title>Secure Instruments</title>
   <link rel="canonical" href="https://www.ratansecurities.com/secure-instruments" />
         ...
         <div class="row">
            <div class="col-xs-12 text-left">
               <ul class="list-inline list-unstyled">
                  ...
                  <li><a class="active" href="secure-instruments">Secure Instruments</a></li>
               </ul>
            </div>
         </div>
      </div>
   </section>
   <section class="tab marb-30 wow fadeInUp">
